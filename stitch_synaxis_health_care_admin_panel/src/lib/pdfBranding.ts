...
export async function drawBrandHeader(doc: jsPDF, company: CompanySettings, title: string) {
  ...
  doc.setTextColor(15, 23, 42); doc.setFont('helvetica', 'bold'); doc.setFontSize(11); doc.text(company.admin_name || company.company_name, textX, 16)
